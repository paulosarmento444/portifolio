...
import { ShoppingBag, Zap, Star, Trophy, Target } from "lucide-react"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-sm rounded-full px-6 py-3 border border-cyan-400/30">
              ...
              <span className="text-cyan-400 font-medium">Nossa Loja</span>
            </div>
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Descubra nossa seleção exclusiva de <span className="text-cyan-400 font-semibold">produtos premium</span>{" "}
              com os melhores preços e{" "}
