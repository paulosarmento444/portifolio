        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-tight">
              ...
              <span className="block text-white">PELO</span>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-700/50">
                ...
                <div className="text-gray-400 text-sm">Atletas Atendidos</div>
              </div>
              <div className="text-center p-4 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-700/50">
                <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  1000+
                </div>
                <div className="text-gray-400 text-sm">Produtos Premium</div>
              </div>
            </div>
          </motion.div>
