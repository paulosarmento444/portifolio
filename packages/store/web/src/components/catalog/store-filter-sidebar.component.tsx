        ...
        <div className="space-y-2">
            ...
            <div className="relative">
                <select
                    ...
                    className={cn(
                        inputClassName,
                        "appearance-none pr-11 font-semibold",
                    )}
                >
        ...
        <div className="space-y-6 rounded-[2rem] border border-[color:var(--store-catalog-sidebar-border)] bg-[color:var(--store-catalog-sidebar-surface)] p-6 shadow-[var(--store-catalog-sidebar-shadow)] ring-1 ring-white/35 backdrop-blur-[14px] dark:ring-white/5">
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm leading-6 text-[color:var(--store-catalog-muted)]">
                                Use a coluna lateral para buscar, organizar e
                                refinar a vitrine antes de comparar os produtos.
                            </p>
                        </div>
                    </div>
            ...
            <section className={sectionClassName}>
                <div className="space-y-1.5">
                    ...
                    <p className="text-xs leading-5 text-[color:var(--store-catalog-soft)]">
                        Procure produtos por nome, categoria ou palavras-chave
                        da vitrine.
                    </p>
                </div>
                <SidebarSearchField
            ...
            <section className={sectionClassName}>
                <div className="space-y-1.5">
                    ...
                    <p className="text-xs leading-5 text-[color:var(--store-catalog-soft)]">
                        Selecione a categoria principal do catálogo para
            ...
            <section className={sectionClassName}>
                <div className="space-y-1.5">
                    ...
                    <p className="text-xs leading-5 text-[color:var(--store-catalog-soft)]">
                        Escolha como os produtos aparecem antes de comparar
                    ...
                    <TextField
                        ...
                        onChange={(event) => {
                            ...
                            handleFilterChange("priceRange", [
                                Math.max(
                                    priceBounds.min,
                                    Math.min(nextMin, filters.priceRange[1]),
                                ),
                    ...
                    <TextField
                        ...
                        onChange={(event) => {
                            ...
                            handleFilterChange("priceRange", [
                                ...
                                Math.min(
                                    priceBounds.max,
                                    Math.max(nextMax, filters.priceRange[0]),
                                ),
                            ] as [number, number]);
                        }}
                        fieldClassName="rounded-[1rem] border-[color:var(--store-catalog-sidebar-border)] bg-[color:var(--store-catalog-sidebar-surface-soft)] text-[color:var(--store-catalog-text)]"
