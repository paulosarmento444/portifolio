...
import type { ChatbotConfig } from "../data/chatbot.types";
import { parseChatbotMarkdown } from "../data/chatbot-markdown";
import { useChatbotWidgetState } from "../data/hooks/use-chatbot-widget-state.hook";
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: parseChatbotMarkdown(message.content),
                            }}
                          />
                        </div>
                      )}
